    ...
    const renderedIcons = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "IconGlobe.useMemo[renderedIcons]": ()=>{
            ...
            return Object.values(data.simpleIcons).map({
                "IconGlobe.useMemo[renderedIcons]": (icon)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icon$2d$cloud$2f$dist$2f$react$2d$icon$2d$cloud$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["renderSimpleIcon"])({
                        icon,
                        size: 42,
                        aProps: {
                            href: undefined,
                            onClick: {
                                "IconGlobe.useMemo[renderedIcons]": (e)=>e.preventDefault()
                            }["IconGlobe.useMemo[renderedIcons]"],
                            tabIndex: -1,
                            style: {
                                pointerEvents: 'none',
...
function t(t, r) {
    return function(n) {
        ...
        if (null != r) {
            var e, o, u, i, c = [], a = !0, l = !1;
            try {
                if (u = (r = r.call(n)).next, 0 === t) {
                    if (Object(r) !== r) return;
                    a = !1;
                } else for(; !(a = (e = u.call(r)).done) && (c.push(e.value), c.length !== t); a = !0);
            } catch (n) {
                l = !0, o = n;
            } finally{
                try {
...
function r(n, t, r1, e = 0) {
    const i = o(n, t, r1), c = i - u(n, t, r1);
    if (c) {
        const e = i === n ? (t - r1) / c : i === t ? (r1 - n) / c : (n - t) / c;
...
function i(n, t) {
    return t.map((t)=>t.reduce((t, r, e)=>t + n[e] * c * (r * c) / c / c, 0));
}
const c = 1e8, a = (n, t)=>s(h(n, t)), l = (n)=>p(f(n)), f = (n)=>n * w / 180, s = (n)=>180 * n / w, d = (n)=>I(f(n)), g = Math.abs, h = Math.atan2, m = Math.cbrt, p = Math.cos, y = Math.exp, b = Math.floor, k = Math.max, v = Math.min, w = Math.PI, M = Math.pow, I = Math.sin, q = Math.sqrt, S = M(6, 3) / M(29, 3), A = M(29, 3) / M(3, 3);
function j(n, t, e, i) {
    const c = r(n, t, e, i), a = o(n, t, e), l = u(n, t, e), f = a - l, s = (a + l) / 2;
    return [
        c,
        0 === f ? 0 : f / (100 - g(2 * s - 100)) * 100,
        s
    ];
}
function x(n, t, r) {
    const o = r <= 50 ? r * (t + 100) / 100 : r + t - r * t / 100, u = 2 * r - o, i = [
        e(u, o, n + 120),
        e(u, o, n),
        e(u, o, n - 120)
    ];
...
function $(n, r, e, o) {
    const u = t(x(n, 100, 50).map((n)=>n * (100 - r - e) / 100 + r), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function z(n, r, e) {
    const o = b(n / 60), u = n / 60 - o & 1 ? n / 60 - o : 1 - n / 60 - o, i = e * (100 - r) / 100, c = e * (100 - r * u) / 100, a = e * (100 - (100 - u) * r / 100) / 100, l = t(5 === o ? [
        e,
        i,
        c
    ] : 4 === o ? [
...
function E(n, r, e) {
    const o = t([
        ...
        r,
        e
    ].map((n)=>n > 4.045 ? 100 * M((n + 5.5) / 105.5, 2.4) : n / 12.92), 3), u = t(i([
        o[0],
        o[1],
        o[2]
    ], [
...
function L(n, r, e) {
    const o = t(i([
        ...
        o[1],
        o[2]
    ].map((n)=>n > .31308 ? 1.055 * M(n / 100, 1 / 2.4) * 100 - 5.5 : 12.92 * n), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function D(n, r, e) {
    const o = (n + 16) / 116, u = r / 500 + o, c = o - e / 200, a = t(i([
        96.42 * (M(u, 3) > S ? M(u, 3) : (116 * u - 16) / A),
        100 * (n > A * S ? M((n + 16) / 116, 3) : n / A),
        82.49 * (M(c, 3) > S ? M(c, 3) : (116 * c - 16) / A)
    ], [
        [
            .9555766,
            -.0230393,
...
function F(n, r, e) {
    const o = t(i([
        ...
        o[1] / 100,
        o[2] / 82.49
    ].map((n)=>n > S ? m(n) : (A * n + 16) / 116), 3), c = u[0], a = u[1];
    return [
        116 * a - 16,
        500 * (c - a),
        200 * (a - u[2])
...
function J(n, t) {
    return function(n, t) {
        const r = k(n, t), e = v(n, t);
        return (r * c + .05 * c) / (e * c + .05 * c);
    }(K(...n), K(...t));
}
function K(n, t, r) {
    return (N(n) * V + N(t) * W + N(r) * X) / c;
}
const N = (n)=>n <= 3.928 ? n / R : Q(n), Q = (n)=>M((n + 5.5) / 105.5, 2.4), R = 1292, V = .2126 * c, W = .7152 * c, X = .0722 * c;
function Y(n) {
    const r = t(n.match(_) || [], 9), e = r[1], o = r[2], u = r[3], i = r[4], c = r[5], a = r[6], l = r[7], f = r[8];
    if (void 0 !== c || void 0 !== e) {
        return [
            void 0 !== c ? parseInt(c, 16) : parseInt(e + e, 16),
            void 0 !== a ? parseInt(a, 16) : parseInt(o + o, 16),
            void 0 !== l ? parseInt(l, 16) : parseInt(u + u, 16),
            void 0 !== f ? parseInt(f, 16) : void 0 !== i ? parseInt(i + i, 16) : 255
        ].map((n)=>100 * n / 255);
    }
}
function Z(n, t, r) {
...
const _ = /^#?(?:([a-f0-9])([a-f0-9])([a-f0-9])([a-f0-9])?|([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?)$/i;
function nn(n) {
    const t = tn[String(n).toLowerCase()];
...
function rn([n, t, r], [e, o, u]) {
    const i = q(M(t, 2) + M(r, 2)), f = q(M(o, 2) + M(u, 2)), s = e - n, h = (n + e) / 2, m = M((i + f) / 2, 7), p = q(m / (m + M(25, 7))), b = t + t / 2 * (1 - p), k = o + o / 2 * (1 - p), v = q(b * b + r * r), w = q(k * k + u * u), I = (v + w) / 2, S = w - v, A = 0 === b && 0 === r ? 0 : a(r, b) % 360, j = 0 === k && 0 === u ? 0 : a(u, k) % 360;
    let x, O, $;
    0 === v || 0 === w ? (x = 0, O = 0, $ = A + j) : (x = g(A - j) <= 180 ? j - A : j <= A ? j - A + 360 : j - A - 360, O = 2 * q(v * w) * d(x / 2), $ = g(A - j) <= 180 ? (A + j) / 2 : A + j < 360 ? (A + j + 360) / 2 : (A + j - 360) / 2);
    const C = 1 - .17 * c * l($ - 30) + .24 * c * l(2 * $) + .32 * c * l(3 * $ + 6) - .2 * c * l(4 * $ - 63) / c / c, z = (h - 50) * (h - 50), E = 1 + .015 * c * z / q(20 + z) / c, L = 1 + .045 * c * I / c, P = 1 + .015 * c * I * C / c, T = 60 * y(-($ - 275) / 25 * (($ - 275) / 25)), U = -2 * p * d(T), B = s / (en * E), D = S / (on * L), F = O / (un * P);
    return q(B * B + D * D + F * F + U * D * F);
}
const en = 1, on = 1, un = 1;
function cn(n, r, e) {
    const o = t(E(n, r, e), 3), u = t(F(o[0], o[1], o[2]), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function an(n, r, e) {
    const o = t(D(n, r, e), 3), u = t(L(o[0], o[1], o[2]), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function ln(n, r, e) {
    const o = t(E(n, r, e), 3), u = t(F(o[0], o[1], o[2]), 3), i = t(G(u[0], u[1], u[2]), 3);
    return [
        i[0],
        i[1],
        i[2]
...
function fn(n, r, e) {
    const o = t(H(n, r, e), 3), u = t(D(o[0], o[1], o[2]), 3), i = t(L(u[0], u[1], u[2]), 3);
    return [
        i[0],
        i[1],
        i[2]
...
function sn(n, r, e) {
    const o = t(U(n, r, e), 3), u = t(T(o[0], o[1], o[2]), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function dn(n, r, e) {
    const o = t(P(n, r, e), 3), u = t(B(n, o[1], o[2]), 3);
    return [
        n,
        u[1],
        u[2]
...
function gn(n, r, e) {
    const o = t(x(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3), i = t(F(u[0], u[1], u[2]), 3);
    return [
        i[0],
        i[1],
        i[2]
...
function hn(n, r, e, o) {
    const u = t(D(n, r, e), 3), i = t(L(u[0], u[1], u[2]), 3), c = t(j(i[0], i[1], i[2], o), 3);
    return [
        c[0],
        c[1],
        c[2]
...
function mn(n, r, e) {
    const o = t(x(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3), i = t(F(u[0], u[1], u[2]), 3), c = t(G(i[0], i[1], i[2]), 3);
    return [
        c[0],
        c[1],
        c[2]
...
function pn(n, r, e, o) {
    const u = t(H(n, r, e), 3), i = t(D(u[0], u[1], u[2]), 3), c = t(L(i[0], i[1], i[2]), 3), a = t(j(c[0], c[1], c[2], o), 3);
    return [
        a[0],
        a[1],
        a[2]
...
function yn(n, r, e) {
    const o = t(x(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function bn(n, r, e, o) {
    const u = t(L(n, r, e), 3), i = t(j(u[0], u[1], u[2], o), 3);
    return [
        i[0],
        i[1],
        i[2]
...
function kn(n, r, e) {
    const o = t($(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3), i = t(F(u[0], u[1], u[2]), 3);
    return [
        i[0],
        i[1],
        i[2]
...
function vn(n, r, e, o) {
    const u = t(D(n, r, e), 3), i = t(L(u[0], u[1], u[2]), 3), c = t(O(i[0], i[1], i[2], o), 3);
    return [
        c[0],
        c[1],
        c[2]
...
function wn(n, r, e) {
    const o = t($(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3), i = t(F(u[0], u[1], u[2]), 3), c = t(G(i[0], i[1], i[2]), 3);
    return [
        c[0],
        c[1],
        c[2]
...
function Mn(n, r, e, o) {
    const u = t(H(n, r, e), 3), i = t(D(u[0], u[1], u[2]), 3), c = t(L(i[0], i[1], i[2]), 3), a = t(O(c[0], c[1], c[2], o), 3);
    return [
        a[0],
        a[1],
        a[2]
...
function In(n, r, e) {
    const o = t($(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function qn(n, r, e, o) {
    const u = t(L(n, r, e), 3), i = t(O(u[0], u[1], u[2], o), 3);
    return [
        i[0],
        i[1],
        i[2]
...
function Sn(n, r, e) {
    const o = t(z(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3), i = t(F(u[0], u[1], u[2]), 3);
    return [
        i[0],
        i[1],
        i[2]
...
function An(n, r, e, o) {
    const u = t(D(n, r, e), 3), i = t(L(u[0], u[1], u[2]), 3), c = t(C(i[0], i[1], i[2], o), 3);
    return [
        c[0],
        c[1],
        c[2]
...
function jn(n, r, e) {
    const o = t(z(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3), i = t(F(u[0], u[1], u[2]), 3), c = t(G(i[0], i[1], i[2]), 3);
    return [
        c[0],
        c[1],
        c[2]
...
function xn(n, r, e, o) {
    const u = t(H(n, r, e), 3), i = t(D(u[0], u[1], u[2]), 3), c = t(L(i[0], i[1], i[2]), 3), a = t(C(c[0], c[1], c[2], o), 3);
    return [
        a[0],
        a[1],
        a[2]
...
function On(n, r, e) {
    const o = t(z(n, r, e), 3), u = t(E(o[0], o[1], o[2]), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function $n(n, r, e, o) {
    const u = t(L(n, r, e), 3), i = t(C(u[0], u[1], u[2], o), 3);
    return [
        i[0],
        i[1],
        i[2]
...
function Cn(n, r, e) {
    const o = t(F(n, r, e), 3), u = t(G(o[0], o[1], o[2]), 3);
    return [
        u[0],
        u[1],
        u[2]
...
function zn(n, r, e) {
    const o = t(H(n, r, e), 3), u = t(D(o[0], o[1], o[2]), 3);
    return [
        u[0],
        u[1],
        u[2]
...
//# sourceMappingURL=_0mrk3t5._.js.map